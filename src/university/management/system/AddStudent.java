...
public class AddStudent extends JFrame implements ActionListener{
     JTextField tfname, tfFather, tfaddress, tfphone, tfemail, tfx, tfxii, tfaadhar;
    JLabel labRollno;
    JDateChooser dcdob;
    ...
    {   getContentPane().setBackground(Color.PINK);
        ...
        tfFather.setBounds(600, 150, 150, 30);
        add(tfFather);
        // 3. Roll no
        ...
        add(lblRollno );
        // label
         labRollno =new JLabel("1533"+first4);
         labRollno.setBounds(250, 200, 200, 30);
         labRollno .setFont(new Font("serif",Font.BOLD,30));
        add(labRollno );
        //4.date
